...
<head>
    ...
    <link rel="stylesheet" href="css/kidz.css">
...
<body>
    <header>
                    ...
                    <div class="col-lg-12 d-block">
                        <div class="row d-flex">
                            <div class="col-md-5 pr-4 d-flex topper align-items-center">
                                ...
                                <span class="text">Condominio Bello Horizonte Nte.
                                    Girardot, Cundinamarca</span>
                            </div>
        ...
        <nav class="navbar navbar-expand-md navbar-white" style="opacity: 1;">
            <div class="container">
                <a href="{{url(route('home'))}}"><img src="images/logo3_nombre.png"></a>
                    ...
                    <ul class="navbar-nav ml-lg-auto">
                        <li class="nav-item dropdown bg-warning">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown1">
                                <li>
                                    <a class="dropdown-item" href="index.html">Kidz School</a>
                                </li>
                                <li>
                        ...
                        <li class="nav-item dropdown bg-danger">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a class="dropdown-item" href="javascript:void(0)">Events<i
                        ...
                        <li class="nav-item dropdown bg-info">
                            <a class="nav-link dropdown-toggle " href="javascript:void(0)" id="stores" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="stores">
                                <li>
                                    <a class="dropdown-item" href="javascript:void(0)">Products<i
                                            class="fa fa-chevron-right" aria-hidden="true"></i></a>
                                    <ul class="sub-menu">
                                ...
                                <li>
                                    <a class="dropdown-item" href="javascript:void(0)">Checkout<i
                                            class="fa fa-chevron-right" aria-hidden="true"></i></a>
                                    <ul class="sub-menu">
                                        <li>
                        ...
                        <li class="nav-item dropdown bg-purple">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="stores">
                                <li>
                                    <a class="dropdown-item" href="javascript:void(0)">Blog Grid<i
                                            class="fa fa-chevron-right" aria-hidden="true"></i></a>
                                    <ul class="sub-menu">
                                ...
                                <li>
                                    <a class="dropdown-item" href="javascript:void(0)">Blog List<i
                                            class="fa fa-chevron-right" aria-hidden="true"></i></a>
                                    <ul class="sub-menu">
                                ...
                                <li>
                                    <a class="dropdown-item" href="javascript:void(0)">Single Blog<i
                                            class="fa fa-chevron-right" aria-hidden="true"></i></a>
                                    <ul class="sub-menu">
                        ...
                        <a class="nav-link dropdown-toggle " href="{{url(route('contact'))}}">
                                    <i class="fa fa-home nav-icon" aria-hidden="true"></i>
    ...
    <footer class="ftco-footer ftco-bg-dark ftco-section">
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-6 col-lg-3">
                    <div class="ftco-footer-widget mb-5">
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                <li><span class="icon icon-map-marker"></span><span class="text">Condominio Bello
                                        Horizonte Nte.
                                        Girardot, Cundinamarca</span></li>
                                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+57 317 847
                                            5977</span></a></li>
                                <li><a href="#"><span class="icon icon-envelope"></span><span
                                            class="text">correo@happykids.com</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="ftco-footer-widget mb-5">
                        <h2 class="ftco-heading-2">Obtener más Información</h2>
                        <form action="#" class="subscribe-form">
                            <div class="form-group">
                                <input type="text" class="form-control mb-2 text-center"
                                    placeholder="Correo Electronico">
                                <input type="submit" value="Obtener Información!" class="form-control submit px-3">
                            </div>
                        </form>
                    </div>
                    <div class="ftco-footer-widget mb-5">
                        <h2 class="ftco-heading-2 mb-0">Mira Nuestras Redes</h2>
    ...
    {{-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBYcI8uUxxvZ0itBhCZj444JRjH30UuUtk&v=3">
    </script> --}}
